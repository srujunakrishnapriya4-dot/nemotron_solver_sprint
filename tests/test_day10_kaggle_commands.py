...
def test_day10_command_plan_includes_pass10b_gates_and_no_submit_command():
    for expected in (
        ...
        "day10_nemotron_lora_target_diagnostics.py",
        "v4_solver_teacher_lora_smoke_bf16_qv.yaml",
        "peft_linear4bit_shape_incompatible",
        "HARD_BLOCKER_GPU_MEMORY_OR_BACKEND",
